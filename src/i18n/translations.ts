export const translations = {
  en: {
    ...
    gardenBioPlaceholder: "Tell others about your garden...",
    more: "More",
    shareGarden: "Share my garden",
    gardenLinkCopied: "Garden link copied!",
    feed: "Feed",
    gardens: "Gardens",
    createPost: "Share something with the community",
    postPlaceholder: "What's growing? Share an update, tip or photo...",
    post: "Post",
    posting: "Posting...",
    ...
    flatList: "All",
    searchPosts: "Search posts, gardeners, plants...",
    ...
    reportSubmitted: "Thanks — our team will review it.",
    reportFailed: "Could not submit report",
    hideContent: "Hide from my feed",
    contentHidden: "Hidden from your feed",
    activity: "Activity",
  ...
  ar: {
    ...
    gardenBioPlaceholder: "أخبر الآخرين عن حديقتك...",
    more: "المزيد",
    shareGarden: "مشاركة حديقتي",
    gardenLinkCopied: "تم نسخ رابط الحديقة!",
    feed: "المنشورات",
    gardens: "الحدائق",
    createPost: "شارك شيئاً مع المجتمع",
    postPlaceholder: "ما الذي ينمو لديك؟ شارك تحديثاً أو نصيحة أو صورة...",
    post: "نشر",
    posting: "جاري النشر...",
    ...
    flatList: "الكل",
    searchPosts: "ابحث في المنشورات والبستانيين والنباتات...",
    noPostsMatch: "لا توجد منشورات مطابقة",
    ...
    reportReason: "السبب",
    reportSpam: "بريد مزعج أو مضلل",
    reportHarassment: "تحرش أو كراهية",
    ...
    reportSubmitted: "شكراً — سيراجع فريقنا البلاغ.",
    reportFailed: "تعذر إرسال البلاغ",
    hideContent: "إخفاء من تغذيتي",
    contentHidden: "تم الإخفاء من تغذيتك",
    activity: "النشاط",
  ...
  pt: {
    ...
    gardenBioPlaceholder: "Conta aos outros sobre o teu jardim...",
    more: "Mais",
    shareGarden: "Partilhar o meu jardim",
    gardenLinkCopied: "Ligação do jardim copiada!",
    feed: "Publicações",
    gardens: "Jardins",
    createPost: "Partilha algo com a comunidade",
    postPlaceholder: "O que está a crescer? Partilha uma novidade, dica ou foto...",
    post: "Publicar",
    posting: "A publicar...",
    noPosts: "Ainda sem publicações. Sê o primeiro a partilhar!",
    likes: "gostos",
    ...
    flatList: "Todos",
    searchPosts: "Procurar publicações, jardineiros, plantas...",
    noPostsMatch: "Nenhuma publicação corresponde",
    sharePost: "Partilhar publicação",
    postLinkCopied: "Ligação copiada!",
    reportPost: "Denunciar publicação",
    reportComment: "Denunciar comentário",
    reportTitle: "Denunciar conteúdo",
    reportReason: "Motivo",
    reportSpam: "Spam ou enganador",
    reportHarassment: "Assédio ou ódio",
    reportInappropriate: "Conteúdo inadequado",
    reportMisinformation: "Desinformação",
    reportOther: "Outro",
    reportDetails: "Adiciona detalhes (opcional)",
    reportSubmit: "Enviar denúncia",
    reportSubmitted: "Obrigado — a nossa equipa irá rever.",
    reportFailed: "Não foi possível enviar a denúncia",
    hideContent: "Ocultar do meu feed",
    contentHidden: "Ocultado do teu feed",
    activity: "Atividade",
    likedYourPost: "gostou da tua publicação",
    commentedOnPost: "comentou a tua publicação",
